...
- *Normales "Im LAN öffnen" bleibt lokal:* e4mcs automatischer Tunnel ist per Laufzeit-Override (`TrackedValue.setOverride`, e4mcs Konfigdatei bleibt unberührt) aus und wird nur fürs Einladen kurz eingeschaltet (`E4mcControl.java`). e4mc ist jetzt immer mitgeliefert (Bundle 26.1.2 + Manifest 1.21.11).
