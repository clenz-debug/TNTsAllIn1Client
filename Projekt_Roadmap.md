...
**Umsetzung Schritt 2 (2026-09-25), gebaut und deployt; allein bestätigt: normales "Im LAN öffnen" bleibt lokal (keine e4mc-Adresse). Der eigentliche Test braucht einen zweiten Spieler (siehe persönliche Liste unten):**
...
- **Offene Tests mit einem zweiten Spieler** (notiert 2026-09-25 - ein Bekannter mit eher schwachem PC hat schon zugesagt; alles hier geht allein nicht):
  ...
  - FPS auf schwacher Hardware: gleiche Welt, gleiche Einstellungen (Sichtweite, Grafik) einmal im normalen Minecraft-Launcher (Vanilla) und einmal mit unserem Client (Sodium/Lithium laufen immer mit), FPS mit dem FPS-Zähler bzw. F3 vergleichen und notieren. Falls es ruckelt: RAM-Einstellung im Launcher prüfen
  - Custom Capes (Phase 7b): sieht er dein hochgeladenes Cape im Spiel, und ist ein HD-Cape unverzerrt?
