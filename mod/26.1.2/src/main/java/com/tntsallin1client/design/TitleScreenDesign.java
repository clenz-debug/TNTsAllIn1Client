...
public final class TitleScreenDesign {
	...
	public static void renderClientBackground(GuiGraphicsExtractor graphics, Font font, int width, int height) {
		...
		graphics.text(font, ClientFont.of(version), 2, height - 10, ClientTheme.withAlpha(theme.text, 0.5f), false);
	}
