...
public final class ArmorStatusHud {
	 ...
	 */
	public static void drawRow(GuiGraphicsExtractor guiGraphics, Font font, Entry entry, int localX, int localY, boolean showIcon, ArmorStatusIconPosition iconPosition, int textVerticalOffset, int textColumnWidth) {
		if (!showIcon) {
		...
		if (iconPosition == ArmorStatusIconPosition.RIGHT) {
			...
			guiGraphics.item(entry.stack(), localX + textColumnWidth + ICON_GAP, localY);
		} else {
