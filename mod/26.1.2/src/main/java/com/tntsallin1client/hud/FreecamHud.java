...
public class FreecamHud implements HudElement {
	...
	@Override
	public void extractRenderState(net.minecraft.client.gui.GuiGraphicsExtractor guiGraphics, DeltaTracker deltaTracker) {
		if (!FreecamHandler.isActive()) {
			return;
		}
		Minecraft client = Minecraft.getInstance();
		guiGraphics.centeredText(client.font, Component.translatable("gui.tntsallin1client.freecam.hud_active"),
