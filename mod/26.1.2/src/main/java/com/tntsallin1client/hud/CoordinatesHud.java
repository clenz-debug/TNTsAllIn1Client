...
public class CoordinatesHud implements HudElement {
	...
	public static void drawLines(GuiGraphicsExtractor guiGraphics, Font font, List<String> lines, float x, float y, float scale, int color) {
		...
		for (String line : lines) {
			guiGraphics.text(font, line, 0, lineY, color);
