...
public final class ColorPickerHelper {
	 ...
	 * (0xFF______) - a bare RGB value passed to GuiGraphicsExtractor is invisible
	...
	public static void drawSwatch(GuiGraphicsExtractor guiGraphics, int x, int y, int size, int argbColor) {
