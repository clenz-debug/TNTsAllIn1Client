...
- Gutes Ingame Menü um die featurs / mods auzuwählen (auch über taste(-nkombie) zu öffnen welche mann selbst einstellen kann) [check] (5e)
    ...
    - material counter verschiebbar machen und item als bild einblenden (wenn in der Material counter mod option eingeschaltet) [check] (5y — verschiebbar war schon seit 5b vorhanden, Item-Bild jetzt neu gebaut, noch nicht live getestet)
