...
**Phase 5 — Eigene Features, leicht → schwer** ✅ abgeschlossen (5a–5f alle live vom Nutzer bestätigt; 5d ist bewusst nur ein erster Wurf, siehe unten)
...
## Nächster Schritt
Phase 4 und Phase 5 (5a–5f) sind abgeschlossen. Offene Punkte, unabhängig voneinander:
...
2. **Phase 6 angehen** (Launcher-UX: Versionsauswahl & Mod-Verwaltung, siehe Roadmap) — Versions-Picker, persistente Instanz-Konfiguration, Mods-Screen (gebündelte Mods an/ausschalten + eigene Fabric-Mod-Jars hinzufügen). Blockiert nicht durch das Phase-3-Warten.
3. **5d optional nachschärfen**, sobald der Nutzer konkreteres Feedback von der Person hat, die das F3-Feature ursprünglich vorgeschlagen hat.
4. **Phase 7+ / Lizenz-Punkte im Hinterkopf behalten:** durch 5f ist jetzt zum ersten Mal ein fremder Mod (Continuity, LGPL-3.0-only) gebündelt — der laut Roadmap ohnehin geplante "Third-Party Licenses/Credits"-Screen (Mod + Launcher) hat damit einen ersten echten Eintrag.
